...
=================================================*/
  function fn_ytVideoBg() {
    ...
    if (!isMobile) {
      $video.attr('data-property', '{videoURL: _ytUrl, autoPlay: true, loop: _ytLoop, startAt: _ytStart, stopAt: _ytEnd, mute: _ytMute, quality: _ytQuality, realfullscreen: true, optimizeDisplay: true, addRaster: false, showYTLogo: false, showControls: false, vol: 100, stopMovieOnBlur: false, containment: "self"}');
      $video.YTPlayer();
      
   //   $video.YTPSetVolume(100);
